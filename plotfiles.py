...
# Function to format large numbers in a human readable format
...
# Load the JSON data
with open('/home/dominik/ba/results/2024-02-07T18:01:56.518021/fileSizes.json') as f:
    data = json.load(f)
...
colors = iter(cm.tab20(np.linspace(0, 1, len(lines))))
